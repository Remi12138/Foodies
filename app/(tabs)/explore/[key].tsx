...
// // Component that accepts the restaurant prop
...
//         {restaurant.businessHours?.open.map((hours, index) => (
//           <Text key={index}>
//             {daysOfWeek[hours.day]}: {formatTime(hours.start)} - {formatTime(hours.end)}
//           </Text>
//         ))}
//         <Text style={{ color: restaurant.businessHours?.isOpenNow ? "green" : "red" }}>
//           {restaurant.businessHours?.isOpenNow ? "Open Now" : "Closed Now"}
//         </Text>
//       </View>
//       <TouchableOpacity
